  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col selection:bg-cyan-500 selection:text-white">
      ...
      <header className="border-b border-slate-800/80 backdrop-blur-md sticky top-0 z-50 bg-slate-950/80">
        <div className="max-w-6xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-teal-500 to-emerald-600 flex items-center justify-center font-black text-xl text-white shadow-lg shadow-cyan-500/10">
              A
            </div>
            <div>
              <span className="font-bold text-lg tracking-tight text-white block leading-tight">Apartament Hubertus</span>
              <span className="text-xs text-cyan-400 font-mono tracking-widest uppercase">apartamenthubertus.pl</span>
            </div>
          </div>
          ...
          <div>
            <a href="#kontakt" className="px-5 py-2.5 rounded-full bg-teal-500 hover:bg-teal-400 text-slate-950 font-medium text-sm transition-all shadow-md">
              Skontaktuj się
            </a>
          </div>
        </div>
      ...
      <section className="relative overflow-hidden py-24 md:py-32 px-6">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-slate-700/80 bg-slate-900/60 text-cyan-300 text-xs font-semibold uppercase tracking-wider mb-8 shadow-inner">
            ...
            Projekt powiązany z domeną apartamenthubertus.pl
          </div>
          <h1 className="text-4xl sm:text-6xl font-extrabold tracking-tight text-white leading-tight mb-6">
            Twój komfortowy dom z dala od domu
          </h1>
          <p className="text-lg sm:text-xl text-slate-400 max-w-2xl mx-auto leading-relaxed mb-10">
            Stylowy, przestronny apartament idealny na rodzinny urlop, weekendowy wyjazd we dwoje lub podróż służbową.
          </p>
          <div className="flex flex-wrap items-center justify-center gap-4">
            <a href="#kontakt" className="px-8 py-4 rounded-xl bg-teal-500 hover:bg-teal-400 text-slate-950 font-bold text-base transition-all shadow-lg">
              Rozpocznij teraz
            </a>
      ...
      <section id="mozliwosci" className="py-20 bg-slate-900/30 border-y border-slate-800/80 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <h2 className="text-3xl font-bold text-white mb-4">Dlaczego Apartament Hubertus?</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="p-8 rounded-2xl bg-slate-900/60 border border-slate-800 hover:border-slate-700 transition-all group">
              ...
              <h3 className="text-xl font-bold text-white mb-3">Doskonała lokalizacja</h3>
              <p className="text-slate-400 leading-relaxed">Blisko centrum i natury, dogodny dojazd i spokojna okolica.</p>
            </div>
            <div className="p-8 rounded-2xl bg-slate-900/60 border border-slate-800 hover:border-slate-700 transition-all group">
              <div className="w-12 h-12 rounded-xl bg-slate-800 text-cyan-400 flex items-center justify-center font-bold text-lg mb-6 group-hover:scale-110 transition-transform">
                02
              </div>
              <h3 className="text-xl font-bold text-white mb-3">Kompletnie wyposażony</h3>
              <p className="text-slate-400 leading-relaxed">Aneks kuchenny, ekspres do kawy, pralka, Smart TV i szybki Internet.</p>
            </div>
            <div className="p-8 rounded-2xl bg-slate-900/60 border border-slate-800 hover:border-slate-700 transition-all group">
              <div className="w-12 h-12 rounded-xl bg-slate-800 text-cyan-400 flex items-center justify-center font-bold text-lg mb-6 group-hover:scale-110 transition-transform">
                03
              </div>
              <h3 className="text-xl font-bold text-white mb-3">Bezdotykowe zameldowanie</h3>
              <p className="text-slate-400 leading-relaxed">Zameldowanie o dowolnej porze za pomocą intuicyjnego kodu dostępu.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="kontakt" className="py-24 px-6 max-w-3xl mx-auto w-full">
        <div className="p-8 sm:p-12 rounded-3xl bg-slate-900/80 border border-slate-800 shadow-2xl backdrop-blur-sm">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-400 text-sm">Masz pytania dotyczące domeny apartamenthubertus.pl? Napisz do nas!</p>
          </div>
          {sent ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button 
                type="submit" 
                className="w-full py-4 rounded-xl bg-teal-500 hover:bg-teal-400 text-slate-950 font-bold transition-all shadow-lg"
              >
                Wyślij wiadomość
              </button>
            </form>
      ...
      <footer className="mt-auto border-t border-slate-800/80 py-8 px-6 bg-slate-950 text-center text-xs text-slate-500">
        <p>&copy; {new Date().getFullYear()} Apartament Hubertus - apartamenthubertus.pl. Wszelkie prawa zastrzeżone.</p>
